...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Александр Борзилов"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Александр Иванов"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Игорь Соколов"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Кирилл Бобырев"  %}

[Постер](/files/posts/opt2018/bobyrev_poster.pdf)

[Код](https://drive.google.com/file/d/1fmRALZn0-BRKlHWK_juP9sswUdpEtCZ0/view?usp=sharing)
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Даниил Селиханович"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Эльвира Зайнулина"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Анастасия Меркулова"  %}

[Постер](/files/posts/opt2018/merkulova_poster.pdf)

[Код](https://colab.research.google.com/drive/1Zq8cmSkOpK11\JhGitLesttTLDKheo1Aa)
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Ангелина Ярошенко"  %}
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Елизавета Киселева"  %}

[Постер](/files/posts/opt2018/kiseleva_poster.pdf)

[Код](https://drive.google.com/file/d/1YNlCwQ37BUf_KSEBRrlnthyN4hVWXn0Y/view?usp=sharing)
...
{% include image-inline.html url="/images/posts/180610_opt2018/kot.png" width="15%" alt=page.post-title caption="Саша и Тёма"  %}
